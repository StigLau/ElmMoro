module DualApproach.Slides exposing (..)

import Html exposing (Html, text, ul, map)
import Json.Decode exposing (Decoder, list)
import Http
import Task
import DualApproach.Slide as Slide
import DualApproach.Modal as Modal
...
getSlides =
    Http.send SlidesResponse <|
        Http.get "http://localhost:8080/kompoback/slides" decoder
